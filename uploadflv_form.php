...
<div class="boxitem" id="A"> 
      <ul> 
	  	<li><a id="A2" href="#" onmouseover="javascript:doClick(this,'A','current')" class="current">网络视频</a></li>  
        <li><a id="A1" href="#" onmouseover="javascript:doClick(this,'A','current')">本地视频</a></li>
