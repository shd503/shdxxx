...
if(checkadminhaspower("badusermessage") =="no") {
    echo "没有操作权限！页面不显示！";
    return;
}
...
if (!$row){
    ...
    <form name="myform" method="post" action="">
        ...
        <table width="100%" border="0" cellpadding="5" cellspacing="1">
            <tr>
                <td width="43" align="center" class="border">ID</td>
                <td width="96" class="border">用户名</td>
                <td width="101" class="border">IP</td>
                <td width="96" class="border">IP状态</td>
                <td width="159" class="border">备注</td>
                <td width="208" class="border">时间</td>
                <td width="238" colspan="2" align="center" class="border">操作</td>
            </tr>
            <?php
