...
$discription=$classname;
		...
		$sql="insert into zzcms_zsclass (parentid,classname,classzm,img,isshow,title,keyword,discription) values('A','$classname','$classzm','$img','$isshow','$title','$keyword','$discription')";
		mysql_query($sql);
...
<input name="classzm" type="text" size="60" maxlength="30"> 
    ...
    <tr>
      ...
      <td class="border"><input name="img" type="text" size="60" maxlength="50">
      </td>
    </tr>
    <tr> 
