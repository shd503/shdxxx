...
if(checkadminhaspower("usergroup") =="no") {
    echo "没有操作权限！页面不显示！";
    return;
}
        ...
        while($row=mysql_fetch_array($rs)){
            ...
            <tr bgcolor="#FFFFFF" onMouseOver="this.bgColor='#E6E6E6'" onMouseOut="this.bgColor='#FFFFFF'">
                ...
                <td width="315" height="22"> <table width="100%" border="0" cellpadding="3" cellspacing="0">
                        <tr>
                            <td width="75%" align="right">查看代理商信息库联系方式：</td>
                            <td width="25%">
                                <?php if (strpos($row["config"],'look_dls_data')!==false){echo "<font color=green>√</font>"; }else{ echo"<font color=red>×</font>"; }?>
                            </td>
                        </tr>
                        <tr>
                            <td align="right">查看代理商留言联系方式：</td>
                            <td>
                                <?php if (strpos($row["config"],'look_dls_liuyan')!==false){echo "<font color=green>√</font>"; }else{ echo"<font color=red>×</font>"; }?>
                            </td>
                        </tr>
                        <tr>
                            <td align="right">打印代理商留言：</td>
                            <td>
                                <?php if (strpos($row["config"],'dls_print')!==false){echo "<font color=green>√</font>"; }else{ echo"<font color=red>×</font>"; }?>
                            </td>
                        </tr>
                        <tr>
                            <td align="right">下载代理商留言：</td>
                            <td>
                                <?php if (strpos($row["config"],'dls_download')!==false){echo "<font color=green>√</font>"; }else{ echo"<font color=red>×</font>"; }?>
                            </td>
                        </tr>
                        <tr>
                            <td align="right">抢占广告位：</td>
                            <td>
                                <?php if (strpos($row["config"],'set_text_adv')!==false){echo "<font color=green>√</font>"; }else{ echo"<font color=red>×</font>"; }?>
                            </td>
                        </tr>
                        <tr>
                            <td align="right">每天查看代理商信息数：</td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td>
                                <?php if (strpos($row["config"],'passed')!==false){echo "<font color=green>√</font>"; }else{ echo"<font color=red>×</font>"; }?>
                            </td>
                        </tr>
                        <tr>
                            <td align="right">上传视频：</td>
                            <td>
                                <?php if (strpos($row["config"],'uploadflv')!==false){echo "<font color=green>√</font>"; }else{ echo"<font color=red>×</font>"; }?>
                            </td>
                        </tr>
                    </table></td>
