...
$to = $fbr_email; //收件人
$subject = "有人在".sitename."上给您留言想要代理".$row["cp"];
$body= "<table width='100%'><tr><td style='font-size:14px;line-height:25px'>".$somane.$sex. "：<br>&nbsp;&nbsp;&nbsp;&nbsp;您好！<br>有人在".sitename."上给您留言，想要代理".$row["cp"]."；以下是部分信息：<hr>";
$body= $body . "留&nbsp;言&nbsp;人：".$row["dlsname"]."<br>代理产品：".$row["cp"]."<br>留言时间：".$row["sendtime"]."<br><a href='".siteurl."/user/login.php' target='_blank'><b>登录网站查看详情</b></a>";
