...
$f="../template/".siteskin."/label/gsshow/".$title.".txt";
...
if ($action=="del") {
checkadminisdo("label");
$f="../template/".siteskin."/label/gsshow/".nostr(trim($_POST["title"])).".txt";
	if (file_exists($f)){
	unlink($f);
	}else{
...
if (file_exists("../template/".siteskin."/label/gsshow")==false){
echo '文件不存在';
}else{		
$dir = opendir("../template/".siteskin."/label/gsshow");
...
$fp="../template/".siteskin."/label/gsshow/".$labelname;
$f=fopen($fp,"r+");
$fcontent="";
while (!feof($f))
{
