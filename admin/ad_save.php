...
$agentadmin=trim($_POST["agentadmin"]);
...
if ($_REQUEST["action"]=="add"){
    mysql_query("INSERT INTO zzcms_ad (bigclassname,smallclassname,title,titlecolor,link,agentadmin,img,imgwidth,imgheight,username,starttime,endtime,elite,sendtime)VALUES('$bigclassname','$smallclassname','$title','$titlecolor','$link','$agentadmin','$img','$imgwidth','$imgheight','$username','$starttime','$endtime','$elite','".date('Y-m-d H:i:s',time()-(showadvdate+1)*60*60*24)."')");
    ...
    mysql_query("update zzcms_ad set bigclassname='$bigclassname',smallclassname='$smallclassname',title='$title',titlecolor='$titlecolor',link='$link',agentadmin='$agentadmin',img='$img',imgwidth='$imgwidth',imgheight='$imgheight',username='$username',nextuser='$nextuser',starttime='$starttime',endtime='$endtime',elite='$elite' where id='$newsid'");
