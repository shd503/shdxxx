...
?>
<div class="admintitle">推广员广告管理</div>
...
<table width="100%" border="0" cellpadding="5" cellspacing="0">
    ...
    <tr>
        <td bgcolor="#FFFFFF" class="border2"> <strong>前台调用代码示例：</strong>
            <input name="js" type="text" id="js" style="width:240px" value="{#showad:首页,A,0,130,90,9,no}" size="40" maxlength="255">
...
<!--            <input type="submit" onClick="myform.action='del.php';myform.target='_self';return ConfirmDel()" value="删除选中的信息">-->
        ...
        <table width="100%" border="0" cellspacing="1" cellpadding="5">
            <tr>
                ...
                <td width="200" class="border">图片</td>
                <td width="100" class="border">代理管理员</td>
                <td width="120" class="border">广告主用户名</td>
                <td width="90" class="border">是否可抢占</td>
            ...
            while($row = mysql_fetch_array($rs)){
                ...
                <tr class="bgcolor1" onMouseOver="fSetBg(this)" onMouseOut="fReBg(this)">
                    ...
                    <td width="100"><?php echo $row["agentadmin"]?></td>
                    <td width="120"><a href="usermanage.php?keyword=<?php echo $row["username"]?>"><?php echo $row["username"]?></a></td>
                    <td width="90">
                        <?php
                        if ($row["elite"]==0){
