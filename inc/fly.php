...
$str=$str . "<div id='gg".$i."' style='position:absolute;z-index:2'>";
...
$str=$str . "#leftDiv,#rightDiv{position:absolute;}";
$str=$str . ".itemFloat{width:auto;height:auto;line-height:5px}";
$str=$str . "</style>";
$str=$str . "<div id='leftDiv' style='top:210px;left:5px'>";
...
$str=$str . "<div id='left".$i."' class='itemFloat'>";
...
$str=$str . "</div>";
$str=$str . "<div id='rightDiv' style='top:210px;right:5px'>";//放到外面，无论有值或无值都显以免JS因打不到rightdiv而报错
...
$i=1;
while($row=mysql_fetch_array($rs)){
$str=$str . "<div id='right".$i."' class='itemFloat'>";
if (strpos("gif|jpg|png|bmp",substr($row["img"],-3))>=0){
$str=$str . "<a target=_blank href=".$row["link"]."><img border=0 src=".siteurl.$row["img"]." width=".$row["imgwidth"]." height=".$row["imgheight"]."></a>";
}elseif (substr($row["img"],-3)=="swf"){
$str=$str . "<embed src=".siteurl.$row["img"]." wmode=transparent width=".$row["imgwidth"]." height=".$row["imgheight"]."></embed>";
