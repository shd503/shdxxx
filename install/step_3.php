...
<div class="body">     
  <table width="100%" border="0" cellpadding="5" cellspacing="1" bgcolor="#dddddd">
	...
	<?php 
	$pass=true;
	$files_array=array("../inc/config.php","../inc/wjt.php","../index.htm","../cache/test.txt","../template/test.txt","../web/test.txt","../uploadfiles/test.txt");
	foreach ($files_array as $files){ ?>
    <tr> 
      <td bgcolor="#FFFFFF"><?php echo str_replace('/test.txt','',$files)?></td>
      <td bgcolor="#FFFFFF"><?php  
	  		if (new_is_writeable($files)==1){
				echo "可写<img src=dui2.gif>";
			} else{
				echo "不可写<img src=error.gif>";
				$pass=false;
			}?></td>
      <td bgcolor="#FFFFFF">可写<img src="dui2.gif" width="18" height="17"></td>
    </tr>
	<?php } ?>
