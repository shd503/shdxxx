...
<div class="body">	
  <table width="100%" cellpadding="4" cellspacing="1" bgcolor="#dddddd" class="bgcolor2">
    ...
    <tr align="center"> 
      ...
      <td bgcolor="#FFFFFF"><?php echo $php_pass ? '通过<img src=dui2.gif>' : '<span style="color:red;">PHP版本过低</span>';?></td>
    </tr>
    <tr align="center"> 
      ...
      <td bgcolor="#FFFFFF">5.0.0及以上</td>
      <td bgcolor="#FFFFFF"><?php echo $mysql_pass ? '通过<img src=dui2.gif>' : '<span style="color:red;">MySQL版本过低</span>';?></td>
    </tr>
    <tr align="center"> 
      ...
      <td bgcolor="#FFFFFF">jpg gif png</td>
      <td bgcolor="#FFFFFF"><?php echo $gd_pass ? '通过<img src=dui2.gif>' : '<span style="color:red;">无法处理图片</span>';?></td>
    </tr>
    <tr align="center"> 
      ...
      <td bgcolor="#FFFFFF">支持</td>
      <td bgcolor="#FFFFFF"><?php echo $url_pass ? '通过<img src=dui2.gif>' : '<span style="color:red;">建议开启</span>';?></td>
    </tr>
    <tr align="center"> 
