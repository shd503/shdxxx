...
'.msgbox_close{float:right;text-align:center;line-height:26px;}' +
'.msgbox_close a:link,.msgbox_close a:hover,.msgbox_close a:visited{color:#FFF;font-weight:bold;text-decoration:none;background-color:#025BAD;padding:2px}' +
'.msgbox_close a:hover{background-color:#CC0000}' +
...
function MsgBox(tt,url,wd,ht,tp){
	...
	var Control2 = "<div class=\"msgbox_close\"><a href=\"index.htm\" title=\"返回首页\">返回首页</a></div>";
	...
	$("msgBox").style.marginTop = (-$("msgBox").offsetHeight + GetBrowserDocument().scrollTop) + "px";
