...
<table width="100%" height="100" border="0" cellpadding="5" cellspacing="0">
      <tr>
        ...
        <a href="/<?php echo getpageurl3("userreg")?>" target="_parent">注册用户</a></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td><input name="yzm" type="text" id="yzm" value="" tabindex="3" size="10" maxlength="50" style="width:40px" class="biaodan"/><img src="/one/code_math.php" align="absmiddle" id="getcode_math" title="看不清，点击换一张" /></td>
      </tr>
      <tr>
