...
?>
      ...
      <table width="100%" border="0" cellpadding="5" cellspacing="1" class="bgcolor">
        <tr> 
          ...
          <td width="20%" class="border">摘要</td>
          <td width="20%" class="border">记帐(积分)</td>
          <td width="20%" class="border">记帐时间</td>
          <td width="20%" class="border">备注</td>
        </tr>
        <?php
$i=1;
...
<div class="border1"><?php echo showpage()?></div>
<?php
}
?>
</div>
