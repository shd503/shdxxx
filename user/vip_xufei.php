...
<table width="100%" border="0" cellpadding="3" cellspacing="1">
            ...
            <tr> 
              ...
              <td class="border"><select name="sj" id="sj">
                  <option value="1" selected>一年(<?php echo $RMB_xufei?>积分)</option>
                  <option value="2">二年(<?php echo 2*$RMB_xufei?>积分)</option>
                  <option value="3">三年(<?php echo 3*$RMB_xufei?>积分)</option>
                  <option value="5">五年(<?php echo 5*$RMB_xufei?>积分)</option>
                </select> </td>
            </tr>
            <tr > 
