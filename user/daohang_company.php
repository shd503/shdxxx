...
if ($action=="modify") {
			...
			$mobile=$_POST["mobile"];
			$qq=$_POST["qq"];
			mysql_query("update zzcms_user set content='$content',img='$img',province='$province',city='$city',xiancheng='$xiancheng',sex='$sex',mobile='$mobile',address='$address',qq='$qq',phone='$phone',homepage='$homepage' where username='".$username."'");
...
if ($row['logins']==0){
echo "<div class='box'>您好！<b>".$username."</b>恭喜您成为本站注册会员！<br>请完善您的公司简介信息，以便生成您公司的展厅页面。 </div>";
}else{
...
new PCAS('province', 'city', 'xiancheng', '<?php echo $row['province']?>', '<?php echo $row["city"]?>', '<?php echo $row["xiancheng"]?>');
                ...
                <tr > 
                  <td align="right" class="border">公司地址<span class="border2">：</span></td>
                  <td class="border"> <input name="address" id="address" tabindex="4" class="biaodan" value="<?php echo $row['address']?>" size="30" maxlength="50">                  </td>
                </tr>
                <tr >
                  <td align="right" class="border2">电话：</td>
                  <td class="border2"><input name="phone" id="phone" class="biaodan" value="<?php echo $row['phone']?>" tabindex="12" size="30" maxlength="50" /></td>
                </tr>
                <tr > 
                  <td align="right" class="border2">公司网站：</td>
                  <td class="border2"> <input name="homepage" id="homepage" class="biaodan" value="<?php if ($row["homepage"]<>'') { echo  $row["homepage"] ;}else{ echo siteurl.getpageurlzs($row['username']);}?>" tabindex="5" size="30" maxlength="100"></td>
                </tr>
                <tr> 
                ...
                <tr> 
                  <td height="50" align="right" class="border"> 上传公司形象图片<span class="border2">：</span><br>
                ...
                <tr > 
                  <td align="right" class="border">联系人QQ<span class="border2">：</span></td>
