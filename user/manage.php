                ...
                <div class="content">
                    ...
                    <FORM name="myform" action="?action=modify" method="post" onSubmit="return CheckForm()">
                        <table width=100% border=0 cellpadding=3 cellspacing=1>
                            ...
                            <tr>
                                <td align="right" class="border">邮箱：</td>
                            ...
                            <tr >
                                ...
                                <td class="border2">
                                    <INPUT name="agentadmin" id="agentadmin" class="biaodan" value="<?php echo $row["agentadmin"]?>" size="30" maxLength="50" disabled="disabled"></td>
                            </tr>
                            <tr >
