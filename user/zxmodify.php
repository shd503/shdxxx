...
?>
          ...
          <tr> 
            ...
            <td class="border">
			 <input name="title" type="text" id="title" size="50" maxlength="255" class="biaodan" value="<?php echo $rowzx["title"]?>" >
 ...
 <label for="wailian">外链新闻</label> <span id="quote"></span> </td>
		  ...
		  ?>
		   ...
		   ?>
            <td align="right" class="border" >链接地址 <font color="#FF0000">（必填）</font>：</td>
 ...
 <script type="text/javascript" src="/3/ckeditor/ckeditor.js"></script>
          ...
          <tr id="trseo">
            <td colspan="2" class="admintitle" ><strong>SEO优化设置</strong></td>
          </tr>
          <tr id="trkeywords">
      ...
      <td colspan="2" class="admintitle" ><strong>浏览权限设置</strong></td>
    </tr>
    <tr id="trquanxian2"> 
